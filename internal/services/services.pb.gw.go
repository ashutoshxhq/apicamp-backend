...
func request_ServiceService_CreateServiceCode_0(ctx context.Context, marshaler runtime.Marshaler, client ServiceServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateServiceCodeRequest
	...
	msg, err := client.CreateServiceCode(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ServiceService_CreateServiceCode_0(ctx context.Context, marshaler runtime.Marshaler, server ServiceServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateServiceCodeRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateServiceCode(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterServiceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServiceServiceServer) error {
	...
	mux.Handle("POST", pattern_ServiceService_CreateServiceCode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ServiceService_CreateServiceCode_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ServiceService_CreateServiceCode_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterServiceServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServiceServiceClient) error {
	...
	mux.Handle("POST", pattern_ServiceService_CreateServiceCode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ServiceService_CreateServiceCode_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ServiceService_CreateServiceCode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"services", "create"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_ServiceService_CreateServiceCode_0 = runtime.ForwardResponseMessage
)
